...
# Try to import from the package, fall back to local imports if not installed
try:
    ...
    from aws_air_quality_predictor.genai.user_profile import UserProfile, EXAMPLE_USER_PROFILE
except ImportError:
...
def generate_basic_poster(city_name, aqi_value, theme=None, output_path=None):
    """
...
def generate_personalized_poster(city_name, aqi_value, user_profile, theme=None, output_path=None):
    """
